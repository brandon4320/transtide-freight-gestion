  ...
  return (
    <div style={{ paddingBottom: '3rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem', marginBottom: '1.5rem' }}>
        {[
          ['Clientes totales', clientes.length, '#2563eb', '#eff6ff'],
          ...
          {filtered.map(c => (
            <div key={c.id} style={{ ...CARD, borderTop: '3px solid #2563eb', position: 'relative' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.75rem' }}>
                <div style={{ width: '38px', height: '38px', borderRadius: '10px', background: '#eff6ff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1rem', fontWeight: 800, color: '#2563eb' }}>
