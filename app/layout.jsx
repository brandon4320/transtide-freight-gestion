...
export const metadata = {
  title: 'Transtide Freight - Dashboard',
          ...
          <aside className="sidebar">
            ...
            <nav style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <a href="/operations" className="nav-item">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="3 6 12 2 21 6 21 16 12 20 3 16 3 6"/><line x1="12" y1="22" x2="12" y2="12"/><line x1="21" y1="6" x2="12" y2="12"/><line x1="3" y1="6" x2="12" y2="12"/></svg>
                Operaciones
              </a>
          ...
          <main className="main-content">
            <header className="top-header">
              ...
              <div className="user-profile">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--text-muted)" strokeWidth="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>
